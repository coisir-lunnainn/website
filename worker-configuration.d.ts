/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f48b5d9e226f42b3d1bed4a752c0850a)
// Runtime types generated with workerd@1.20260317.1 2024-10-22 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		CONTACT_DETAILS: KVNamespace;
		SEND: SendEmail;
		ASSETS: Fetcher;
		GITHUB_CLIENT_ID: "Ov23liGzAsxk1oNlWZTj";
		SITE_KEY: "0x4AAAAAAB-8r-NGIS50M4J6";
		GH_PAT: string;
		SITE_VERIFY: string;
	}
}
