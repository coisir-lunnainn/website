...
<div
  class="rounded-full fixed bg-black shadow-lg bottom-3 right-4 {editing
    ? 'bg-green-500'
    : ''}"
>
  <button class="p-3 flex gap-2" on:click={editing ? save : enableEditing}>
    {#if editing}
      <span class="text-white font-normal pl-2">Save</span>
      <svg
